    ...
    <footer className={`footer ${darkMode && !cubeVisible ? 'footer-dark' : ''} ${cubeVisible ? 'matchCube' : ''}`} style={styles}>
      <div className="footer-content">
        ...
        <div className="social-links">
          ...
          <a href="https://www.instagram.com/andrew.dickman_/" target="_blank" rel="noopener noreferrer"><span className={`${darkMode ? 'footer-dark footer-dark-links' : 'footer-dark-links-out'}`}>Instagram</span></a>
        </div>
      </div>
    </footer>
  );
